...
const PollutantInfo = ({ pollutant }) => {
  const getPollutantInfo = (pollutant) => {
    switch (pollutant) {
      ...
      case 'no2':
        return 'Nitrogen Dioxide (NO2) primarily gets in the air fro m burning fuel. It can cause respiratory problems and contribute to the formation of other pollutants.';
      case 'so2':
